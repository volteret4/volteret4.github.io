...
Genera estadÃ­sticas anuales de coincidencias entre usuarios
"""
...
def generate_yearly_stats(years_ago: int = 0):
    ...
    # Si es el aÃ±o actual, usar fecha actual como lÃ­mite
    if years_ago == 0:
        to_date = now
    ...
    print(f"ðŸ“Š Generando estadÃ­sticas anuales: {period_label}")
...
def create_html(stats: Dict, users: List[str]) -> str:
    """Crea el HTML para las estadísticas anuales con categorías desplegables"""
...
def main():
    parser = argparse.ArgumentParser(description='Generador de estadÃ­sticas anuales de Last.fm')
    parser.add_argument('--years-ago', type=int, default=0,
                       help='NÃºmero de aÃ±os atrÃ¡s (0 = aÃ±o actual)')
